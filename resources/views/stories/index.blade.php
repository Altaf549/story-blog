...
@section('title', ($category?->name ? ($category->name.' Stories - Story Blog') : 'All Stories - Story Blog'))

@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold">{{ $category?->name ? ($category->name.' Stories') : 'All Stories' }}</h1>
    </div>
